...
from tpsh_test_mode1.page.page_login_error import pageLogin
from tpsh_test_mode1.tools.until import Driver_GET, read_json, read_json_all
...
class test_Tpshop_Login(unittest.TestCase):
    ...
    # # 手机登录
    # @parameterized.expand(read_json('web_login_err.json', 'login_1'))
    # def test_login_phone(self, phone, pwd, code, expect_text):
    #     print(phone, pwd, code)
    #     try:
    #         self.web_ele.page_login_err(phone, pwd, code)
    #         # 获取文本
    ...
    # 邮箱登录
    @parameterized.expand(read_json_all('web_login_err.json'))
